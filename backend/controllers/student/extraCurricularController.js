...
const tableName = 'student_extra_curricular_activities';
const sectionName = 'extraCurricular';

const getExtraCurricular = async (req, res) => {
  try {
  ...
  try {
    ...
    if (Array.isArray(mappedData)) {
        for (const item of mappedData) {
            ...
            if (!item.activity_name || !item.activity_type) continue;
