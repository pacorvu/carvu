...
const { getAllDrives, getDriveById, getDriveRegistrations, registerForDrive, createDrive, updateDrive } = require('../../controllers/placement/driveController');
...
router.get('/:id/registrations', authenticateToken, getDriveRegistrations);
