...
import { ViewIcon, CalendarIcon, StarIcon, SearchIcon } from '@chakra-ui/icons';
...
const CompanyLayout = ({ children }) => {
  ...
  const navItems = [
    { path: '/company/dashboard', label: 'Dashboard', icon: ViewIcon },
    { path: '/company/drives', label: 'My Drives', icon: CalendarIcon },
    { path: '/company/projects', label: 'Student Projects', icon: SearchIcon },
  ];
          ...
          <Flex justify="space-between" align="center" h={{ base: '60px', md: '72px' }}>
            <HStack spacing={{ base: 4, md: 8 }}>
              <HStack onClick={() => navigate('/company/dashboard')} cursor="pointer" spacing={3}>
                <Image src="/logo.png" alt="Company Portal" w="220px" objectFit="contain" mt={-2} />
                <Text color="white" fontWeight="bold" fontSize="xl" mt={2}>Company Portal</Text>
              </HStack>
