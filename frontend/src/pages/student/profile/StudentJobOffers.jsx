...
export const StudentJobOffers = () => {
  ...
  const acceptedOffers = offers.filter(o => normalizeStatus(o.offer_letter_status) === 'Accepted');
  const pendingOffers = offers.filter(o => {
    const s = normalizeStatus(o.offer_letter_status);
    return s === 'Pending' || s === 'Released';
  });
  const rejectedOffers = offers.filter(o => normalizeStatus(o.offer_letter_status) === 'Rejected');
